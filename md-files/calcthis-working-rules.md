...
* Violated FOUR times already (2026-09-13 x2, 2026-09-14, 2026-09-22) despite being called out each time — this is the FIRST hard rule at the top of `CLAUDE.md` now. Re-check it there every response.
* Self-check before EVERY text block, not just at session start: "is this narrating an action, or stating a result / asking a question?" If narrating — cut it, act instead.
