...
* Violated three times already (2026-09-13 x2, 2026-09-14) despite being called out each time — this is the FIRST hard rule at the top of `CLAUDE.md` now. Re-check it there every response.
